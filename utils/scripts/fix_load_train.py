...
for cell in nb['cells']:
    if cell['cell_type'] == 'code':
        ...
        if "def load_or_train(model, model_name, train_loader, epochs=5):" in source_str:
            print("Found load_or_train cell. Replacing...")
            cell['source'] = new_load_or_train
            found = True
...
if found:
    with open(notebook_path, 'w') as f:
        json.dump(nb, f)
    print("Notebook patched: load_or_train updated.")
else:
    print("load_or_train definition not found.")
